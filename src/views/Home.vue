        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad explora el estado de los derechos de los niños y las niñas en la primera infancia, en Colombia, enfocándose en la salud, la educación y la protección contra la violencia. Aunque existen políticas y normativas, persisten brechas significativas, especialmente en contextos rurales y vulnerables. Se destacan desafíos como la desnutrición, la falta de acceso educativo y el maltrato infantil. A través de casos, datos y estrategias pedagógicas, se busca formar docentes críticos, comprometidos con entornos seguros, inclusivos y equitativos que promuevan el desarrollo integral y la garantía de derechos para la infancia.
